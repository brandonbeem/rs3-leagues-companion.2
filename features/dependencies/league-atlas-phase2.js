(()=>{
  ...
  function legacyRegionInfo(svg,def){
    ...
    if(!target)return {target:null,unlocked:Boolean(def.autoUnlocked),selected:false};
    ...
    return {target,unlocked:Boolean(def.autoUnlocked)||selected||unlocked,selected};
  }
